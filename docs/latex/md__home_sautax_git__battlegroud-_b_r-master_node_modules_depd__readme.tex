...
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md425}{}\doxysection{Install}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md425}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s A\+PI to no longer display or track deprecations.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md426}{}\doxysection{A\+PI}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md426}
...
{\bfseries{N\+O\+TE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md427}{}\doxysubsection{depd(namespace)}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md427}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md428}{}\doxysubsection{deprecate(message)}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md428}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md429}{}\doxysubsection{deprecate.\+function(fn, message)}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md429}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md430}{}\doxysubsection{deprecate.\+property(obj, prop, message)}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md430}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md431}{}\doxysubsection{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md431}
...
\end{DoxyCode}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md432}{}\doxysubsection{process.\+env.\+N\+O\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md432}
...
{\bfseries{N\+O\+TE}} This will not suppress the deperecations given to any \char`\"{}deprecation\char`\"{} event listeners, just the output to S\+T\+D\+E\+RR.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md433}{}\doxysubsection{process.\+env.\+T\+R\+A\+C\+E\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md433}
...
{\bfseries{N\+O\+TE}} This will not trace the deperecations silenced by {\ttfamily N\+O\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}.\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md434}{}\doxysection{Display}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md434}
...
\DoxyCodeLine{                                             the word "deprecated"}
\end{DoxyCode}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md435}{}\doxysection{Examples}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md435}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md436}{}\doxysubsection{Deprecating all calls to a function}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md436}
...
\end{DoxyCode}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md437}{}\doxysubsection{Conditionally deprecating a function call}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md437}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md438}{}\doxysubsection{Deprecating property access}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md438}
...
\end{DoxyCode}
\hypertarget{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md439}{}\doxysection{License}\label{md__home_sautax_git__battlegroud-_b_r-master_node_modules_depd__readme_autotoc_md439}
